"""
STEP 1: FORECAST BY KABUPATEN
==============================
Membuat forecast traffic untuk masing-masing kabupaten (119 kabupaten)
dengan ensemble forecasting (MA + WMA + ES) + event-based New Year pattern.

Input:
  - Traffic_VLR_Java_2024-2025.xlsx

Output:
  - forecast_results/04_kabupaten/[kabupaten]_forecast.csv
  - forecast_results/04_kabupaten/[kabupaten]_forecast.png
"""
