"""
AGGREGATE ALL WEB DATA (FORECAST)
==================================
Menjalankan semua agregasi data forecast untuk web dashboard.

Output: forecast_outputs/*.csv → auto-copy ke ../public/web_data/
...
def main():
    ...
    print("="*80)
    print(" FORECAST DATA AGGREGATION - GENERATE ALL CSV")
    print("="*80)
    print()
    
    # Create forecast_outputs directory
